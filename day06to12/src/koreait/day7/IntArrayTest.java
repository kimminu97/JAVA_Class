...
public class IntArrayTest {	//정수값 배열을 연습합니다.
	//배열 : 일반 변수는 변수 1개에 데이터 1개 저장합니다. 많은 데이터를 저장할때 배열을 사용
...
//		2) 초기화 없이(기본값은 0) 배열의 크기만 정합니다.
		...
		//배열 데이터의 위치(0부터 시작): 인덱스,기호[] 사용합니다.
		...
		arr2[4] = 78;
		System.out.println("arr2배열 5번째 데이터의 값 : " + arr2[4]);
		...
		//발전방향: arr2배열의 난수값 만들때 중복된 값은 제외합니다. 그리고 6개를 한쌍으로 5번 만듭니다. -> Lotto
	}
}
