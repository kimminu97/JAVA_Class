...
public class CharArrayTest {
	...
	public static void main(String[] args) {
		...
		System.out.println("carr1배열 3번째 데이터의 값 : " + carr1[2]);	
		System.out.println("carr2배열 3번째 데이터의 값 : " + carr2[2]);
...
//		carr2 = "hello hi goodbye";	//char배열에 바로 문자열 대입은 오류
		...
		carr2 = "hello hi goodbye goodbye goodbye".toCharArray();	//선언된 배열의 크기보다 클때 
