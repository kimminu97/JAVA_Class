...
public class MyClass1Test {
	...
	public static void main(String[] args) {
		...
		MyClass1 cls1 = new MyClass1();	//MyClass1()은 생성자 메소드 실행
...
//		MyClass1 cls33 = new MyClass1(3.14);	//오류 : 인자의 데이터 타입과 맞는 커스텀생성자 없음
		System.out.println("f2필드만 초기화");
		cls3.print();
		
		double[] test = new double[4];
		MyClass1 cls4 = new MyClass1(test);
		System.out.println("f3필드만 초기화");	//double 배열을 만들어서 참조값을 cls4객체에 전달
		cls4.print();
		...
		cls4.f3[2]=999.9912;
		System.out.println("cls5 객체 f3[2] 값 확인 : "+ cls5.f3[2]);	//cls4와 cls5 객체 f3필드는 동일한 배열(주소 같습니다)
		System.out.println("cls5 객체 f3[2] 값 확인 : "+ cls5.f3[0]);
	}
