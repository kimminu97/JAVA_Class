...
//생성자 메소드 연습합니다.(리턴값은 없고, 인자는 있을 수 있는 메소드)- constructor
//	->생성자 메소드 실행으로 객체가 만들어집니다.
//	->기본생성자 : 인자가 없는 형식의 생성자
//	->커스텀생성자 : 필드값 초기화를 위해 인자가 있는 형식의 생성자
	int f1;			//default 접근권한
	String f2;
	double[] f3;
	...
	public MyClass1() {
	//커스텀생성자를 정의하면 기본생성자는 생략을 할 수 없습니다.-> 필요하다면 기본생성자 정의가 필요함
	}
	...
	public MyClass1(double[] f3) {	//배열변수는 주소(참조값) 전달
		this.f3=f3;
	}
