...
//	final int test;	//final 변수는 꼭 초기값을 저장해야합니다.
...
//		fval2=123;		//final 변수는 값을 변경 못합니다.
		...
		//클래스의 일반저긍로 기본형 상수 필드를 대문자로 표기합니다.
	}
...
//	3.메소드 인자로 선언된 변수 : 해당 메소드{ }안에서 사용하는 지역변수
	...
	void nonStatic(int a) {
		...
		System.out.println("-------------");
//		fval=100;	//fval 변수는 값을 변경할 수 없습니다. ->final 키워드 사용
	}
	// static 에서는 static만
	// nonstatic 에서는 static, nonstatic 둘다 사용
