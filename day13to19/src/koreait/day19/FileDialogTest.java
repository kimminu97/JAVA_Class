...
//자바에서도 GUI를 만들수 있는 클래스들이 있습니다. 그 중 하나인 파일대화상자를 사용합니다.
//Windows OS는 프로그램들이 window라는 틀 안에서 만들어지는 자바에서는 그것은 프레임이라고 합니다.
		...
		String filename = fdr.getDirectory() + fdr.getFile();	//선택한 파일 경로와 파일명 연결
