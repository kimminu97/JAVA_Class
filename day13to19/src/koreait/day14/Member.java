...
public class Member {
	...
	//회원이 분양받습니다. 회원나이가 강아지는 15세이상, 고양이는 18세이상, 토끼는 13세이상 분양받을수 있다.(처리조건)
	boolean isAdopt(Animal animal) {
		//Animal 자식클래스 Puppy,Cat,Rabbit 객체가 animal변수로 참조하게 됩니다.
		//현재 회원객체가 인자로 전달받은 animal 객체를 분양자격이 되는지 반환
